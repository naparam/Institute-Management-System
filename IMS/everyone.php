...
<body>
   ...
   <div id="top">
      <div><a href="index.php" title="Log out"><b>Log Out</b></a>&nbsp;&nbsp;&nbsp; <b>language:</b>
            <select name="#">
                ...
                <div id="leftmanu">
                 ...
                 <div>
                    ...
                    <div>
                     ...
                     <div>
                    	<a href="everyone.php?tag=faculties_entry" class="customer" title="Shift+3">&nbsp;Facility Entry</a>
                    </div>
					...
					<div>
                     ...
                     <div>
                    	<a href="everyone.php?tag=view_artical" class="customer" title="Shift+9">&nbsp;About Us</a>
                    </div>
                    
                     <div>
                    	<a href="everyone.php?tag=view_contact" class="customer" title="Shift+Ctrl+C">&nbsp;Contact </a>
                    </div>
                     <div>
                    	<a href="" class="customer" title="Shift+7"></a>
                    </div>
                    
                     <div>
                    	<a href="" class="customer" title="Shift+8"></a>
                    </div>
                     ...
                     <div>
                    	<a href="everyone.php?tag=test_score" class="customer" title="Shift+Ctrl+T"></a>
                    </div>
    ...
    <div id="rmain">
    	<div id="pic_manu">
         ...
         <div id="menu2">
                ...
                <li id="li_menu"><a href="">Facilities</a>
                
                    
                    <ul>
                        <li id="li_submenu"><a href="everyone.php?tag=faculties_entry" class=" order">Facility Entry</a></li>
                        <li id="li_submenu"><a href="everyone.php?tag=view_faculties" class="customer">View Facility</a></li>
                    </ul>
           ...
           <li id="li_menu"><a href="">Score</a>
                ...
                <li id="li_menu"><a href="">AboutUs</a>
                    ...
                    <ul>
                        <li id="li_submenu"><a href="everyone.php?tag=view_artical" class="customer">AboutUs</a></li>
                    </ul>
                ...
                <li id="li_menu"><a href="">Contact</a>
                	...
                	<ul>
                    	<li id="li_submenu"><a href="everyone.php?tag=view_contact" class="customer">Contact</a></li>
